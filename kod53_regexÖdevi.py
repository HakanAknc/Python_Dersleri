s = "No. Wrong. Choice is an illusion, created between those with power, and those without."\
    " This is the nature of the universe. "\
    "We struggle against it, we fight to deny it, but it is of course pretense, it is a lie. "\
    "Beneath our poised appearance, the truth is we are completely out of control. Causality."\
